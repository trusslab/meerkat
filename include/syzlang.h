...
int find_in_items(const std::vector<TypeTag> &, const std::string &);
bool is_in_items(const std::vector<TypeTag> &, const std::string &);
bool is_in_needed(const std::vector<TypeTag> &, const std::string &);
